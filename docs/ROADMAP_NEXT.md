...
Status: In Umsetzung (Control-Lock + Restart-Taker aktiv; Tactical-Positioning offen)
Ziel:
...
Status: In Umsetzung (shootable penalty flow + basic save/rebound aktiv; aiming/keeper-depth offen)
Ziel:
